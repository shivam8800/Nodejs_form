$(document).ready(function(){
  var blackLine = $(".black-line"),
      ...
      // Start
      tl
      .to(blackLine,0,{className:'+=red-circle'})
      .to(blackLine,0,{className:'-=red-circle'})
      .to(blackLine,0,{className:'+=red-circle'})
      .to(blackLine,0,{className:'-=red-circle'})
      .to(blackLine,0,{className:'+=red-circle'})
      ...
      .to(blackLine,0,{className:'+=red-circle'})
      .to(blackLine,0,{className:'-=red-circle'})
      .to(ball,0,{y:"-70%",ease:Power4.easeOut})
      .to(ball,0,{y:"-50%",ease:Bounce.easeOut})
      .to(ball,0,{y:"-85%",ease:Power4.easeOut},"+=0.5")
      .to(ball,0,{y:"-50%",ease:Bounce.easeOut})
      .to(ball,0,{y:"-100%",ease:Power4.easeOut},"+=0.5")
      .to(ball,0,{y:"-50%",ease:Bounce.easeOut,onComplete:toggle})
      ;
      function toggle(o){
